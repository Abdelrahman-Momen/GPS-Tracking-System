...
void MCAL_UART_CONFIG(UART_Select UART_NO, uint8_t DATA_BITS, uint8_t PARITY, uint8_t STOP_BITS, uint32_t IBRD,uint32_t FBRD){
    ...
    switch (UART_NO) {
        ...
        case UART0:
            ...
            UART0_IBRD &= ~UART_IBRD_MASK;                          //reset before write
            UART0_IBRD |= IBRD;                                     //write claculated baud rate int
            
            UART0_FBRD &= ~UART_FBRD_MASK;                          //reset before write
            UART0_FBRD |= FBRD;                                     //write claculated baud rate float
            ...
            UART0_CTL |= (UARTEN | UART_CTL_RXE | UART_CTL_TXE);    //re-enable UART , RX, TX
        ...
        case UART1:
            ...
            UART1_IBRD &= ~UART_IBRD_MASK;                          //reset before write
            UART1_IBRD |= IBRD;                                     //write claculated baud rate int
            
            UART1_FBRD &= ~UART_FBRD_MASK;                          //reset before write
            ...
            UART1_CTL |= (UARTEN | UART_CTL_RXE | UART_CTL_TXE);     //re-enable UART , RX, TX
        ...
        case UART2:
            ...
            UART2_IBRD &= ~UART_IBRD_MASK;                          //reset before write
            UART2_IBRD |= IBRD;                                     //write claculated baud rate int
            
            UART2_FBRD &= ~UART_FBRD_MASK;                          //reset before write
            UART2_FBRD |= FBRD;                                     //write claculated baud rate float
            ...
            UART2_CTL |= (UARTEN | UART_CTL_RXE | UART_CTL_TXE);     //re-enable UART , RX, TX
        ...
        case UART3:
            ...
            UART3_IBRD &= ~UART_IBRD_MASK;                          //reset before write
            UART3_IBRD |= IBRD;                                     //write claculated baud rate int
            
            UART3_FBRD &= ~UART_FBRD_MASK;                          //reset before write
            UART3_FBRD |= FBRD;                                     //write claculated baud rate float
            ...
            UART3_CTL |= (UARTEN | UART_CTL_RXE | UART_CTL_TXE);     //re-enable UART , RX, TX
        ...
        case UART4:
            ...
            UART4_IBRD &= ~UART_IBRD_MASK;                          //reset before write
            UART4_IBRD |= IBRD;                                     //write claculated
            
            UART4_FBRD &= ~UART_FBRD_MASK;                          //reset before write
            UART4_FBRD |= FBRD;                                     //write claculated b
            ...
            UART4_CTL |= (UARTEN | UART_CTL_RXE | UART_CTL_TXE);     //re-enable UART , RX, TX
        ...
        case UART5:
            ...
            UART5_IBRD &= ~UART_IBRD_MASK;                          //reset before write
            UART5_IBRD |= IBRD;                                     //write claculated baud rate int
            
            UART5_FBRD &= ~UART_FBRD_MASK;                          //reset before write
            UART5_FBRD |= FBRD;                                     //write claculated baud rate float
            ...
            UART5_CTL |= (UARTEN | UART_CTL_RXE | UART_CTL_TXE);    //re-enable UART , RX, TX
        ...
        case UART6:
            ...
            UART6_IBRD &= ~UART_IBRD_MASK;                          //reset before write
            UART6_IBRD |= IBRD;                                     //write claculated baud rate int
            
            UART6_FBRD &= ~UART_FBRD_MASK;                          //reset before write
            UART6_FBRD |= FBRD;                                     //write claculated baud rate float
            ...
            UART6_CTL |= (UARTEN | UART_CTL_RXE | UART_CTL_TXE);    //re-enable UART , RX, TX
        ...
        case UART7:
            ...
            UART7_IBRD &= ~UART_IBRD_MASK;                          //reset before write
            UART7_IBRD |= IBRD;                                     //write claculated baud rate int
            
            UART7_FBRD &= ~UART_FBRD_MASK;                          //reset before write
            UART7_FBRD |= FBRD;                                     //write claculated baud rate float
            ...
            UART7_CTL |= (UARTEN | UART_CTL_RXE | UART_CTL_TXE);    //re-enable UART , RX, TX
...
uint8_t MCAL_UART_ReadChar(UART_Select UART_NO){
    ...
    switch(UART_NO)
    {
        ...
        case UART4:
        while(MCAL_UART_ReadAvailable(UART_NO));
        return (uint8_t)(UART4_DR &= UART_DATA_MASK) ;
        break;
        
        case UART5:
        while(MCAL_UART_ReadAvailable(UART_NO));
        return (uint8_t)(UART5_DR &= UART_DATA_MASK) ;
        break;
        
        case UART6:
        while(MCAL_UART_ReadAvailable(UART_NO));
        return (uint8_t)(UART6_DR &= UART_DATA_MASK) ;
        break;
        
        case UART7:
        while(MCAL_UART_ReadAvailable(UART_NO));
        return (uint8_t)(UART7_DR &= UART_DATA_MASK) ;
        break;
